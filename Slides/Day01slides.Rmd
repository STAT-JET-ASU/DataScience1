---
title: "STT 3530 Data Science 1<br>Day 1"
author: "Jill Thomley"
date: "`r Sys.Date()`"
...
Welcome to the first day of STT 3530 Data Science 1 S19 with Dr. Thomley. To prepare for the start of class...
...
knitr::include_graphics("RStudioLogIn.jpg", dpi = 150)
```
...
* Sign in or create an account on [GitHub](https://github.com/). Use your ASU email address. 

* Create a username similar to firstnamelastname when you register. For example, my username is *jillthomley*. If you have a popular name such as John Smith, you may need to provide some other distinquishing characteristic.

* Sometime outside of class, request a [student discount](https://education.github.com/) to get a few private repositories. 
...
As we review these documents, remember that STT 3530 is a 3 credit hour course. The standard expectation for an upper level college course is that you will spend **3** hours outside of class for every **1** hour spent in class.

<p style="text-align: center;">3 + (3 &times; 3) = 12 hours per week</p>

There are no prerequisites other than some basic mathematics proficiency for this course. Students are not expected to have statistics or programming experience. If you do come into the course with one or both, you _may_ not require as much time to master course concepts, but do not assume until you try. 
...
* Have you taken a statistics or programming class before?
...
<p style="text-align: center;"><img src = "https://imgs.xkcd.com/comics/code_quality.png"></p>

<p style="text-align: center;"><img src = "https://imgs.xkcd.com/comics/code_quality_3.png"></p>


##

<p style="text-align: center;"><img src = "https://imgs.xkcd.com/comics/machine_learning.png"></p>


##

<p style="text-align: center;"><img src = "https://raw.githubusercontent.com/STAT-JET-ASU/Moodlepics/master/Nope-Space.gif?token=ALn2zT1xjvkKKCTrvFK20YRDhkSXrMidks5cR1howA%3D%3D"></p>
