...
* Complete _Working with the Rstudio IDE (Part II)_ [(DataCamp)](https://datacamp.com)
...
* For additional ideas see Summer Sun's blog [post](http://blog.nycdatascience.com/featured/nyc-citi-bike-migration-visulization/). 
```
