...
* We will be using free digital textbooks/resources in this course.
    ...
    + Additional items as per schedule
...
* Create [DataCamp](https://www.datacamp.com/) account
* Reflection #01
...
* Take notes as you work though the DC modules. The goal is to learn, not just finish!
* RStudio has helpful [Cheat Sheets](https://www.rstudio.com/resources/cheatsheets/)! Start with the ones for _Base R_ and _R Markdown_.
...
* Refer to [_R Markdown: The Definitive Guide_](https://bookdown.org/yihui/rmarkdown/) for more information on formatting Markdown reports as well as creating web sites and slides, which you will do later in the course. 
* More information about R Markdown can be found at [`R Markdown` from ![](https://www.rstudio.com/wp-content/uploads/2016/09/RStudio-Logo-Blue-Gray-125.png)](http://rmarkdown.rstudio.com) 
```
...
* The [`tidyverse`](https://www.tidyverse.org/) is "an opinionated collection of R packages designed for data science" that share a common philosophy for data manipulation, exploration and visualization."" It is the kernel of our course textbook [_R for Data Science_](http://r4ds.had.co.nz/).
...
*  Our [final exam time](https://registrar.appstate.edu/sites/registrar.appstate.edu/files/asu_spring_2019_exam_schedule.pdf) is Thursday May 09 @ 2:00pm in XXX. You will present XXX.
```
