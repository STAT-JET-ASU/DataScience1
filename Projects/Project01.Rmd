...
* [Global CO2 Growth dataset](https://raw.githubusercontent.com/STAT-JET-ASU/DataScience1/master/Projects/CO2growthG.csv)
...
* Use the weekly Mauna Loa data to create a plot showing the change in CO2 for one year, 10 years, and since 1800. You will need to create new variables for the 1-year and 10-year change in CO~2~.
